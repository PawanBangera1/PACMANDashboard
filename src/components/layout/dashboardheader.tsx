  ...
  return (
     <div className="mx-auto mb-4 overflow-hidden border border-slate-300/80 bg-white shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.2fr_auto] gap-0 items-stretch">
          ...
          <div className="flex items-center gap-3 px-3 py-1 md:py-1">
          ...
          <div className="flex items-center justify-center gap-6 px-5 py-1 text-xs">
          ...
          <div className="flex items-center justify-center gap-3 px-5 py-1 md:py-4 bg-[#3c3c3c] md:border-l border-slate-300">
